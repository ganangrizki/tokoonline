				...
				<?php 
					if (isset($_POST['submit'])) {
						...
						if (!in_array($type2, $tipe_diizinkan)) {
							...
							//jika format file yang sesuai dengan yang ada di dalam array tipe diizinkan 
							// proses upload file sekaligus insert ke database
							move_uploaded_file($tmp_name, './produk/'.$newname);
							

							$insert = mysqli_query($konek,"INSERT INTO tb_product VALUES(
										null,
										'".$kategori."',
										'".$nama."',
										'".$harga."',
